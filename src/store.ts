...
export const DEFAULT_CUSTOM_COLORS: Record<ColorTheme, CustomColors> = {
  ...
  botanical: {
    keycapsAlpha: '#e2e8f0',
    keycapsMod: '#1e3a2f',
    keycapsAccent: '#10b981',
    keycapsText: '#064e3b',
    knobColor: '#10b981',
    switchStem: '#10b981',
    switchHousing: '#1e3a2f',
    switchTopHousing: '#e2e8f0',
    switchSpring: '#f59e0b',
    stabilizerHousing: '#1e3a2f',
    stabilizerStem: '#10b981',
    stabilizerWire: '#10b981',
    plate: '#1e3a2f',
    pcb: '#064e3b',
    caseColor: '#0f291e',
    weightBar: '#10b981',
  ...
  olivia: {
    keycapsAlpha: '#fdf2f8',
    keycapsMod: '#18181b',
    keycapsAccent: '#f43f5e',
    keycapsText: '#881337',
    knobColor: '#fb7185',
    switchStem: '#f43f5e',
    switchHousing: '#18181b',
    switchTopHousing: '#fdf2f8',
    switchSpring: '#fb7185',
    stabilizerHousing: '#18181b',
    stabilizerStem: '#f43f5e',
    stabilizerWire: '#fb7185',
    plate: '#fb7185',
    pcb: '#18181b',
    caseColor: '#1c1917',
    weightBar: '#fb7185',
  ...
  cafe: {
    keycapsAlpha: '#fef3c7',
    keycapsMod: '#38220f',
    keycapsAccent: '#b45309',
    keycapsText: '#451a03',
    knobColor: '#d97706',
    switchStem: '#d97706',
    switchHousing: '#38220f',
    switchTopHousing: '#fef3c7',
    switchSpring: '#f59e0b',
    stabilizerHousing: '#38220f',
    stabilizerStem: '#d97706',
    stabilizerWire: '#f59e0b',
    plate: '#78350f',
    pcb: '#38220f',
    caseColor: '#241407',
  ...
  nautilus: {
    keycapsAlpha: '#06b6d4',
    keycapsMod: '#0f172a',
    keycapsAccent: '#eab308',
    keycapsText: '#083344',
    knobColor: '#eab308',
    switchStem: '#06b6d4',
    switchHousing: '#0f172a',
    switchTopHousing: '#083344',
    switchSpring: '#eab308',
    stabilizerHousing: '#0f172a',
    stabilizerStem: '#eab308',
    stabilizerWire: '#eab308',
    plate: '#eab308',
    pcb: '#0f172a',
    caseColor: '#070d18',
    weightBar: '#06b6d4',
  ...
  laser: {
    keycapsAlpha: '#3b82f6',
    keycapsMod: '#581c87',
    keycapsAccent: '#ec4899',
    keycapsText: '#ffffff',
    knobColor: '#ec4899',
    switchStem: '#ec4899',
    switchHousing: '#581c87',
    switchTopHousing: '#ec4899',
    switchSpring: '#06b6d4',
    stabilizerHousing: '#581c87',
    stabilizerStem: '#ec4899',
    stabilizerWire: '#06b6d4',
    plate: '#ec4899',
    pcb: '#3b0764',
    caseColor: '#1e0538',
    weightBar: '#ec4899',
  ...
  dracula: {
    keycapsAlpha: '#f8fafc',
    keycapsMod: '#1e1e2e',
    keycapsAccent: '#bd93f9',
    keycapsText: '#282a36',
    knobColor: '#ff79c6',
    switchStem: '#50fa7b',
    switchHousing: '#282a36',
    switchTopHousing: '#bd93f9',
    switchSpring: '#ff79c6',
    stabilizerHousing: '#282a36',
    stabilizerStem: '#50fa7b',
    stabilizerWire: '#ff79c6',
    plate: '#bd93f9',
    pcb: '#1e1e2e',
    caseColor: '#14141d',
    weightBar: '#ff79c6',
  ...
  retro: {
    keycapsAlpha: '#f5f5f4',
    keycapsMod: '#78716c',
    keycapsAccent: '#dc2626',
    keycapsText: '#1c1917',
    knobColor: '#dc2626',
    switchStem: '#dc2626',
    switchHousing: '#78716c',
    switchTopHousing: '#f5f5f4',
    switchSpring: '#f59e0b',
    stabilizerHousing: '#78716c',
    stabilizerStem: '#dc2626',
    stabilizerWire: '#f59e0b',
    plate: '#a8a29e',
    pcb: '#292524',
    caseColor: '#44403c',
  ...
  apollo: {
    keycapsAlpha: '#cbd5e1',
    keycapsMod: '#1e293b',
    keycapsAccent: '#f97316',
    keycapsText: '#0f172a',
    knobColor: '#f97316',
    switchStem: '#f97316',
    switchHousing: '#1e293b',
    switchTopHousing: '#cbd5e1',
    switchSpring: '#f59e0b',
    stabilizerHousing: '#1e293b',
    stabilizerStem: '#f97316',
    stabilizerWire: '#f59e0b',
    plate: '#f97316',
    pcb: '#0f172a',
    caseColor: '#111827',
